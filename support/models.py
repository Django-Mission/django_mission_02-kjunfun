...
class Faq(models.Model):
    ...
    category = models.CharField(verbose_name='카테고리',max_length=20,choices=C_CHOICES,null=True)# 카테고리
...
class Answer(models.Model):
    ...
    category = models.CharField(verbose_name='카테고리',max_length=20,choices=C_CHOICES,null=True)
    author = models.ForeignKey(User,verbose_name='작성자',on_delete=models.CASCADE, null=True)
